package com.mibaldi.architectcoders2.ui.common
...
import com.mibaldi.architectcoders2.App
...
suspend fun Geocoder.getFromLocationCompat(
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
        ...
        continuation.resume(getFromLocation(latitude, longitude, maxResults) ?: emptyList(),null)
    }
}
